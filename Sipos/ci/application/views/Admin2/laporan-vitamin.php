<form class="user" action="<?php echo base_url('Laporan_Vitamin/cari_nama');?>" method="get" enctype="multipart/form-data">
<br>
<div class="row">
                <div class="col-sm-12">
            ...
            <div class="col-12">
                <div class="card m-b-30">
                    ...
                    <div class="btn-group">
                                <a href="Laporan_Vitamin/lihat"  class="btn btn-primary btn-sm float-right">Cari</a>
                         </div>
                    </div>