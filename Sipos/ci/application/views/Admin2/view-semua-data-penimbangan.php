                                ...
                                <div class="col-8">
                                            ...
                                            <br></a>
                                                        ...
                                                        <div class="container align-items-center">
                                                            <form action="<?php echo base_url('Data_Penimbangan/filter');?>" method="get">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-1 form-group">
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <a href="<?php echo base_url('Data_Penimbangan/lihat_semua_data_penimbangan')?>"  class="btn btn-outline-primary ml-2">Reset</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </form>
