...
<div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Data Pemberian Vitamin <?= $lihat['nama'] ?></h4>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <p>
                            <a href="<?php echo base_url('Data_Vitamin/tambah_data?id_anak=' . $id_anakk) ?>">
                        ...
                        <div class="container align-items-center">
                            <form action="<?php echo base_url('Data_Vitamin/data_per_anak/' . $id_anakk); ?>" method="get">
                                <div class="row">
                                    ...
                                    <div class="col-sm-1 form-group">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a href="<?php echo base_url('Data_Vitamin/data_per_anak/' . $id_anakk) ?>" class="btn btn-outline-primary ml-2">Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php
                                                echo '<a href="' . base_url('Data_Vitamin/detail_data/' . $baris->id_vitamin . '?id_anakk=' . $id_anakk) . '"><button type="button" class="btn-warning">Lihat</button></a>';
                                                echo " ";
                                                echo '<a href="' . base_url('Data_Vitamin/edit_data/' . $baris->id_vitamin . '?id_anakk=' . $id_anakk) . '"><button type="button" class="btn-primary">Edit</button></a>';
                                                echo " ";
                                                echo '<button type="button" class="btn-danger" data-toggle="modal" data-target="#deleteModal" data-id-vitamin="' . $baris->id_vitamin .  '?id_anakk=' . $id_anakk . '">Hapus</button>';
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Hapus Data Vitamin</h5>
...
<!-- END wrapper -->
<script src="<?= base_url('assets/js/delete-confirm-data-vitamin.js') ?>"></script>