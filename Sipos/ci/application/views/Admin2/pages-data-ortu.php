<form class="user" action="<?php echo base_url('Data_Ortu/data-ortu');?>" method="POST" enctype="multipart/form-data">
    <br>
                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <p>
                                <a href="<?php echo base_url('Data_Ortu/tambah_data')?>">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <?php
                                                echo '<a href="'.base_url('Data_Ortu/detail_data/'.$baris->id_ortu).'"><button type="button" class="btn-warning">Lihat</button></a>';
                                                
                                                echo " ";
                                                echo '<a href="'.base_url('Data_Ortu/edit_data/'.$baris->id_ortu).'"><button type="button" class="btn-primary">Edit</button></a>';
                                                
                                                echo " ";
                                                echo '<button type="button" class="btn-danger" data-toggle="modal" data-target="#deleteModal" data-id-data-ortu="' . $baris->id_ortu . '">Hapus</button>';
                                                ?></td>
                                            </tr>
                                            <?php
                                                }?>
    ...
    <!-- END wrapper -->
    <script src="<?= base_url('assets/js/delete-confirm-data-ortu.js') ?>"></script>