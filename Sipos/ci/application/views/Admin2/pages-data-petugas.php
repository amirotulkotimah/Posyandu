<form class="user" action="<?php echo base_url('Data_Petugas/data-petugas');?>" method="POST" enctype="multipart/form-data">
    <br>
                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <p>
                                <a href="<?php echo base_url('Data_Petugas/tambah_data')?>">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <?php
                                                echo '<a href="'.base_url('Data_Petugas/detail_data/'.$baris->id_petugas).'"><button type="button" class="btn-warning">Lihat</button></a>';
                                                
                                                echo " ";
                                                echo '<a href="'.base_url('Data_Petugas/edit_data/'.$baris->id_petugas).'"><button type="button" class="btn-primary">Edit</button></a>';
                                                
                                                echo " ";
                                                echo '<button type="button" class="btn-danger" data-toggle="modal" data-target="#deleteModal" data-id-data-petugas="' . $baris->id_petugas . '">Hapus</button>';
                                                ?></td>
                                            </tr>
                                            <?php
                                                }?>
    ...
    <!-- END wrapper -->
    <script src="<?= base_url('assets/js/delete-confirm-data-petugas.js') ?>"></script>