                    ...
                    <div class="topbar">
                        <nav class="navbar-custom">
                            <ul class="list-inline float-right mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light nav-user text-white " data-toggle="dropdown" href="#" role="button"
                                        aria-haspopup="false" aria-expanded="false">
                                        <img src="<?php echo base_url('assets/upload/fotopengguna/') .$this->session->userdata('session_foto');?>" alt="" class="rounded-circle text-white "> &nbsp<?php echo ($this->session->userdata('session_nama'));?>
                                    </a>
